...
NUM_EQUIV_VOLUMES = 1_000  # number of locations in which to place civilizations
MAX_CIVS = 5_000  # maximum number of advanced civilizations
TRIALS = 1_000  # number of times to model a given number of civilizations
