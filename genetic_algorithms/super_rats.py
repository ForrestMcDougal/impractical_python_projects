...
# ensure even-nmber of rats for breeding pairs
if NUM_RATS % 2 != 0:
    NUM_RATS += 1
...
def mutate(children, mutate_odds, mutate_min, mutate_max):
    """Randomly alter rat weights using input adds & fractional changes."""
...
def main():
    ...
    print(f"number of years = {int(generations / LITTER_PER_YEAR)}")
