...
def prep_training(raw_haiku):
    """Load string, remove newline, split words on space, and return list."""
...
def map_word_to_word(corpus):
    ...
    logging.debug('map_word_to_word results for "sake" is %s\n', dict1_to_1["sake"])
    return dict1_to_1
