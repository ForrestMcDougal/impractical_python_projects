...
class Game(tk.Frame):
    ...
    def create_widgets(self):
        """Create labeel, button, and text widgets for game."""
        ...
        for text, row, column, columnspan, sticky in instr_input:
            ...
            instr_lbl.grid(
                row=row, column=column, columnspan=columnspan, sticky=sticky, ipadx=30
            )
        ...
        self.unchanged_wins_txt = tk.Text(
            self.parent,
            width=20,
            height=1,
            wrap=tk.WORD,
        ...
        self.no.grid(row=2, column=3, sticky="N", padx=20)
    ...
    def win_reveal(self):
        ...
        self.parent.after(2_000, self.update_image)
    ...
    def show_final(self):
        ...
        self.unchanged_wins_txt.insert(
            1.0, f"Unchanged wins = {self.first_choice_wins:d}"
        )
        self.changed_wins_txt.delete(1.0, "end")
        self.changed_wins_txt.insert(1.0, f"Changed wins = {self.pick_change_wins:d}")
